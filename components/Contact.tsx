        ...
        <div className="bg-warm-gray-50">
          <div className="py-24 lg:py-32">
            <div className="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
              ...
              <p className="m-5 block  text-center tracking-wide text-xl">
                Have a project for me, or just want to say hello? Feel free to
                email me via the form below.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <ul role="list" className="mt-8 flex space-x-12">
                    <li>
                      <a
                        ...
                        href="https://www.linkedin.com/in/kaprestridge/"
                        target="_blank"
                        rel="noreferrer"
                      >
                    ...
                    <li>
                      <a
                        className="text-indigo-200 hover:text-indigo-100"
                        href="https://github.com/kaprestridge"
                        target="_blank"
                        rel="noreferrer"
                      >
                    ...
                    <li>
                      <a
                        className="text-indigo-200 hover:text-indigo-100"
                        href="https://twitter.com/katcoding"
                        target="_blank"
                        rel="noreferrer"
                      >
